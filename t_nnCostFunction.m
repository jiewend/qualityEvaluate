function [J grad] = t_nnCostFunction(nn_params, ...
                                   input_layer_size, ...
                                   hidden_layer_size, ...
                                   num_labels, ...
                                   X, y, lambda)
...
a2 = sigmoid(Xadd_a0 * Theta1');% 5000 * 25
a2add_a0 = [ones(size(a2, 1), 1) a2];% 5000 * 26
a3 = sigmoid(a2add_a0 * Theta2');%5000 * 10
Y = zeros(size(a3));%5000 * 10
for i = 1:m,
	Y(i, y(i)) = 1;
end,
